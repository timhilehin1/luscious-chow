...
function ScrollToTop() {
	...
	return (
		...
		>
			<button 
				onClick={scrollToTop}
				className='w-8 h-8 rounded-[50%] flex justify-center items-center text-customBlack bg-customGold border border-customGold text-center hover:w-10 hover:h-10'
			>
