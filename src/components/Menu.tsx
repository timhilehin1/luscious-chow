                  ...
                  <div className="flex flex-col gap-4 w-full">
                    {filteredProducts.map(
                      (product: ProductData, productIndex: number) => (
                        ...
                        >
                          <div className="lg:w-0 w-full h-[200px] lg:h-0 group-hover:h-[200px]  
						  relative group-hover:w-full md:max-w-[180px] group-hover:md:min-h-[130px] 
						  group-hover:lg:h-auto duration-[600ms] ease-in-out max-h-[450px] shrink-0">
                            <Image
